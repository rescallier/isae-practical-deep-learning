...
# %%
trainval_dataset.items = trainval_dataset.items[:min(len(trainval_dataset), MAX_ITEMS)]
...
with open(os.path.join(data_dir, "toy_aircraft_dataset.npz"), "wb") as f:
...
# %%
# try to reload
toy_dataset = np.load(os.path.join(data_dir, "toy_aircraft_dataset.npz"))
